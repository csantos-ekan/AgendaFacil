...
export const DeleteResourceConfirmationModal: React.FC<DeleteResourceConfirmationModalProps> = ({ 
  isOpen, 
  onClose, 
  onConfirm,
  resource 
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-[400px] overflow-hidden animate-fade-in-up">
        <div className="p-8 text-center">
          ...
          <h3 className="text-xl font-bold text-[#1E293B] mb-2">Excluir Recurso?</h3>
          <p className="text-sm text-[#64748B] mb-8 leading-relaxed">
            Você está prestes a excluir o item <span className="font-bold text-dark">{resource.name}</span>. 
            Esta ação removerá o recurso permanentemente do inventário das salas.
          </p>
